...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="spacecraft-simulator-gui" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" -Djava.util.logging.config.file="%NMF_HOME%\logging.properties" -Dnmf.platform.impl=${platform} opssat.simulator.main.MainClient %CMD_LINE_ARGS%
