...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="cli-tool" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" -Djava.util.logging.config.file="%NMF_HOME%\logging.properties" -Dnmf.platform.impl=${platform} esa.mo.nmf.clitool.CLITool %CMD_LINE_ARGS%
