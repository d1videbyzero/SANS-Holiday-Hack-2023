...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="consumer-test-tool" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" -Djava.util.logging.config.file="%NMF_HOME%\logging.properties" -Dnmf.platform.impl=${platform} esa.mo.nmf.ctt.guis.ConsumerTestToolGUI %CMD_LINE_ARGS%
